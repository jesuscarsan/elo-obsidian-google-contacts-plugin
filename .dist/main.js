...
// ../../libs/obsidian-plugin/src/Infrastructure/Obsidian/ObsidianNoteRepository.ts
...
var _GoogleContactTransformer = class _GoogleContactTransformer {
  ...
  updateFrontmatterFromContact(frontmatter, contact) {
    ...
    this.updateFieldIfMissing(frontmatter, import_dist.FrontmatterKeys.Telefono, contact.phone);
    this.updateFieldIfMissing(frontmatter, import_dist.FrontmatterKeys.Email, contact.email);
    this.updateFieldIfMissing(frontmatter, import_dist.FrontmatterKeys.Cumpleanos, contact.birthday);
    this.updateFieldIfMissing(frontmatter, "aliases", contact.nickname ? [contact.nickname] : void 0);
    this.updateFieldIfMissing(frontmatter, import_dist.FrontmatterKeys.Puesto, contact.jobTitle);
    this.updateFieldIfMissing(frontmatter, import_dist.FrontmatterKeys.Empresa, contact.organization);
    this.updateFieldIfMissing(frontmatter, import_dist.FrontmatterKeys.Direcciones, contact.addresses);
    this.updateFieldIfMissing(frontmatter, import_dist.FrontmatterKeys.Urls, contact.urls);
    this.updateFieldIfMissing(frontmatter, import_dist.FrontmatterKeys.Eventos, contact.events);
    this.updateFieldIfMissing(frontmatter, import_dist.FrontmatterKeys.Relaciones, contact.relations);
    this.updateFieldIfMissing(frontmatter, import_dist.FrontmatterKeys.Genero, contact.gender);
    this.updateFieldIfMissing(frontmatter, import_dist.FrontmatterKeys.Ocupaciones, contact.occupations);
    this.updateFieldIfMissing(frontmatter, import_dist.FrontmatterKeys.Intereses, contact.interests);
    this.updateFieldIfMissing(frontmatter, import_dist.FrontmatterKeys.Habilidades, contact.skills);
    this.updateFieldIfMissing(frontmatter, import_dist.FrontmatterKeys.Residencias, contact.residences);
    if (contact.customFields) {
  ...
  toContactFromMetadata(basename, frontmatter, allFileTags) {
    ...
    return {
      ...
      phone: this.clean(this.toArray(frontmatter[import_dist.FrontmatterKeys.Telefono])),
      email: this.clean(this.toArray(frontmatter[import_dist.FrontmatterKeys.Email])),
      birthday: this.clean(frontmatter[import_dist.FrontmatterKeys.Cumpleanos]),
      nickname: this.getStringFromCleaned(this.clean(frontmatter["aliases"])),
      jobTitle: this.clean(frontmatter[import_dist.FrontmatterKeys.Puesto]),
      organization: this.clean(frontmatter[import_dist.FrontmatterKeys.Empresa]),
      customFields: {
        eloSyncDate: (/* @__PURE__ */ new Date()).toISOString()
      },
